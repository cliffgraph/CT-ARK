...
//
// #define DEF_SPI_TX_PIN  3		// GP3 spi0 TX	pin.5
// #define DEF_SPI_RX_PIN  4		// GP4 spi0 RX	pin.6
// #define DEF_SPI_SCK_PIN 2		// GP2 spi0 SCK	pin.4
// #define DEF_SPI_CSN_PIN 5		// GP5 spi0 CSn	pin.7
